...
class _AdminMultimediaCRUDState extends State<AdminMultimediaCRUD> {
  final DatabaseReference _databaseRef = FirebaseDatabase.instance.ref().child('videos');
 ...
 void _editarMultimedia(String key, Map value) {
  showDialog(
    ...
    builder: (context) {
      ...
      final descripcionController = TextEditingController(text: value['descripcion']);
      ...
      final duracionController = TextEditingController(text: value['duracion']);
      final restriccionController = TextEditingController(text: value['restriccion']);
              ...
              child: Column(
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: const InputDecoration(labelText: 'Restricción'),
                  ),
                ...
                onPressed: () async {
                  try {
                    ...
                    if (newVideoPath != null) {
                      ...
                      await videoRef.putFile(File(newVideoPath!), SettableMetadata(contentType: 'video/mp4'));
                    ...
                    if (newThumbnailPath != null) {
                      final thumbnailRef = FirebaseStorage.instance
                          .ref()
                          .child('thumbnails/${DateTime.now().millisecondsSinceEpoch}.jpg');
                      await thumbnailRef.putFile(File(newThumbnailPath!), SettableMetadata(contentType: 'image/jpeg'));
                      updatedThumbnailUrl = await thumbnailRef.getDownloadURL();
                    }
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text('Multimedia actualizada con éxito')),
                    );
                  } catch (e) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(content: Text('Error al actualizar multimedia: $e')),
                    );
                  }
                },
